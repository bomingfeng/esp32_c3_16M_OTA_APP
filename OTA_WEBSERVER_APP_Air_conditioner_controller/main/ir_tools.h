...
struct ir_builder_s {
    ...
    */
    esp_err_t (*build_frame)(ir_builder_t *builder, uint32_t data1, uint32_t data2, uint32_t data3,uint8_t data4);
...
struct ir_parser_s {
    ...
    */
    esp_err_t (*get_scan_code)(ir_parser_t *parser,uint32_t *data1, uint32_t *data2, uint32_t *data3,uint8_t *data4);
