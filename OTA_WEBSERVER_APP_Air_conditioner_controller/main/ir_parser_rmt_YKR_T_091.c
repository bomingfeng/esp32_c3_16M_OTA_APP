...
static esp_err_t YKR_T_091_parser_get_scan_code(ir_parser_t *parser, uint32_t *data1, uint32_t *data2, uint32_t *data3,uint8_t *data4)
{
    esp_err_t ret = ESP_FAIL;
    uint32_t addr = 0;uint8_t addr1;
    bool logic_value = false;
    YKR_T_091_parser_t *YKR_T_091_parser = __containerof(parser, YKR_T_091_parser_t, parent);
