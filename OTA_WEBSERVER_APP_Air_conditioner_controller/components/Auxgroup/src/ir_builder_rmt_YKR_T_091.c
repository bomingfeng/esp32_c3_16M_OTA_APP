...
static esp_err_t YKR_T_091_build_frame(ir_builder_t *builder, uint8_t * ir_tx_data)
{
    int i;
    uint32_t data1 = (ir_tx_data[0] << 24) | (ir_tx_data[1] << 16) | (ir_tx_data[2] << 8) | ir_tx_data[3];
    uint32_t data2 = (ir_tx_data[4] << 24) | (ir_tx_data[5] << 16) | (ir_tx_data[6] << 8) | ir_tx_data[7];
    uint32_t data3 = (ir_tx_data[8] << 24) | (ir_tx_data[9] << 16) | (ir_tx_data[10] << 8) | ir_tx_data[11];
    uint32_t data4 = (ir_tx_data[12] << 24);
